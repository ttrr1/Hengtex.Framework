using Hengtex.CodeGenerator.Model;
using Hengtex.Util;
using System;
...
namespace Hengtex.CodeGenerator.Template
{
    /// <summary>
    /// 版 本 1.0
    ...
    public class MultiTable
    {
        ...
        public string EntityBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> gridColumnModel, bool isChildTable)
        {
            ...
            try
            {
                ...
                sb.Append("using Hengtex.Application.Code;\r\n\r\n");


                sb.Append("namespace Hengtex.Application.Entity." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
                sb.Append("    /// Copyright (c) 2012-2017 恒泰纺织\r\n");
        ...
        public string EntityMapBuilder(MultiTableConfigModel multiTableConfigModel, bool isChildTable)
        {
            try
            {
                ...
                StringBuilder sb = new StringBuilder();
                sb.Append("using Hengtex.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
                sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

                sb.Append("namespace Hengtex.Application.Mapping." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
                sb.Append("    /// Copyright (c) 2012-2017 恒泰纺织\r\n");
        ...
        public string ServiceBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> colModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Hengtex.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hengtex.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hengtex.Data.Repository;\r\n");
            sb.Append("using Hengtex.Util.WebControl;\r\n");
            sb.Append("using System;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Linq;\r\n");
            sb.Append("using Hengtex.Util;\r\n");
            sb.Append("using Hengtex.Util.Extension;\r\n\r\n");

            sb.Append("namespace Hengtex.Application.Service." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.0\r\n");
            sb.Append("    /// Copyright (c) 2012-2017 恒泰纺织\r\n");
        ...
        public string IServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("namespace Hengtex.Application.IService." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.0\r\n");
            sb.Append("    /// Copyright (c) 2012-2017 恒泰纺织\r\n");
        ...
        public string BusinesBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("using Hengtex.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hengtex.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hengtex.Application.Service." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hengtex.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace Hengtex.Application.Busines." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.0\r\n");
            sb.Append("    /// Copyright (c) 2012-2017 恒泰纺织\r\n");
        ...
        public string ControllerBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Hengtex.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hengtex.Application.Busines." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hengtex.Util;\r\n");
            sb.Append("using Hengtex.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace Hengtex.Application.Web.Areas." + multiTableConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.0\r\n");
            sb.Append("    /// Copyright (c) 2012-2017 恒泰纺织\r\n");
