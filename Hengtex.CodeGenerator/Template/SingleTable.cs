using Hengtex.CodeGenerator.Comm;
...
namespace Hengtex.CodeGenerator.Template
{
    ...
    public class SingleTable
    {
        ...
        public string EntityBuilder(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.Append("namespace Hengtex.Application.Entity." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Hengtex.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

            sb.Append("namespace Hengtex.Application.Mapping." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
            sb.Append("    /// Copyright (c) 2012-2017 恒泰纺织\r\n");
        ...
        public string ServiceBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Hengtex.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hengtex.Application.IService." + baseConfigModel.OutputAreas + ";\r\n");
            ...
            sb.Append("namespace Hengtex.Application.Service." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.0\r\n");
            sb.Append("    /// Copyright (c) 2012-2017 恒泰纺织\r\n");
        ...
        public string IServiceBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("namespace Hengtex.Application.IService." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.0\r\n");
            sb.Append("    /// Copyright (c) 2012-2017 恒泰纺织\r\n");
        ...
        public string BusinesBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("using Hengtex.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hengtex.Application.IService." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hengtex.Application.Service." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hengtex.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace Hengtex.Application.Busines." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.0\r\n");
            sb.Append("    /// Copyright (c) 2012-2017 恒泰纺织\r\n");
        ...
        public string ControllerBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Hengtex.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hengtex.Application.Busines." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hengtex.Util;\r\n");
            sb.Append("using Hengtex.Util.WebControl;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace Hengtex.Application.Web.Areas." + baseConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.0\r\n");
            sb.Append("    /// Copyright (c) 2012-2017 恒泰纺织\r\n");
