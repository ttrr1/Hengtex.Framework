...
//登录
.controller('LoginCtrl', ['$scope', '$state', '$timeout', 'md5', '$hengtexTopAlert', '$hengtexHttp', 'ApiUrl', 'UserInfo', 'lrmIM',
    function ($scope, $state, $timeout, md5, $hengtexTopAlert, $hengtexHttp, ApiUrl, UserInfo, lrmIM) {
        $scope.data = {};
...
//主页
.controller('HomeCtrl', [
    '$scope', '$hengtexPageModal', 'HomeApps', 'Announces',
  function ($scope, $hengtexPageModal, HomeApps, Announces) {
...
.controller('CasesCtrl', [
    '$scope', '$hengtexPageModal', 'Cases', function ($scope, $hengtexPageModal, Cases) {
