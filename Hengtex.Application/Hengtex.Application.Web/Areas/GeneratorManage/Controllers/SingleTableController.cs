using Hengtex.Application.Busines.AuthorizeManage;
...
using Hengtex.CodeGenerator;
using Hengtex.CodeGenerator.Model;
using Hengtex.CodeGenerator.Template;
using Hengtex.Util;
using System;
...
namespace Hengtex.Application.Web.Areas.GeneratorManage.Controllers
{
    /// <summary>
    /// 版 本 1.0
