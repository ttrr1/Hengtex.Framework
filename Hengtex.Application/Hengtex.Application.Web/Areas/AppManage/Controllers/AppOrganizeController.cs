...
namespace Hengtex.Application.Web.Areas.AppManage.Controllers
{
    ...
    /// 描 述：机构管理
    /// </summary>
    public class AppOrganizeController : MvcControllerBase
    {
        ...
        public ActionResult GetTreeJson(string keyword)
        {
            ...
            foreach (AppOrganizeEntity item in data)
            {
        ...
        [ValidateAntiForgeryToken]
        [AjaxOnly]
        public ActionResult SaveForm(string keyValue, AppOrganizeEntity organizeEntity)
        {
