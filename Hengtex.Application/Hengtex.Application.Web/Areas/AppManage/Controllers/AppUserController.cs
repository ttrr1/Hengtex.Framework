...
namespace Hengtex.Application.Web.Areas.AppManage.Controllers
{
    ...
    /// 描 述：用户管理
    /// </summary>
    public class AppUserController : MvcControllerBase
    {
        private AppUserBLL userBLL = new AppUserBLL();
        private AppUserCache userCache = new AppUserCache();
        ...
        {
            //AppUserEntity userEntity = strUserEntity.ToObject<AppUserEntity>();
