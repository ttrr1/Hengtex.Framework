...
function(n, t) {
    ...
    n.fn.comboBoxTree = function(i) {
        ...
        f = {
            ...
            loadData: function(i) {
                ...
                function(n, t) {
                    var r = top.hengtex.data.get(["dataItem", i.dataItemName, t[i.text]]);
                    r != "" && (t[i.text] = r);
                    i.data.push(t)
                })) : i.data = r
            },
    ...
    n.fn.authorizeButton = function() {
        ...
        r = top.hengtex.data.get(["authorizeButton", u]);
    ...
    n.fn.authorizeColModel = function() {
        ...
        t = top.hengtex.data.get(["authorizeColumn", u]);
...
function(n) {
    ...
    n.RemoveForm = function(n) {
        hengtex.removeForm(n)
    };
    n.ConfirmAjax = function(n) {
        hengtex.confirmAjax(n)
    };
    n.ExistField = function(n, t, i) {
        hengtex.existField(n, t, i)
    };
    n.getDataForm = function(n) {
        hengtex.getDataForm(n)
    }
} (window.jQuery);
...
dialogOpen = function(n) {
    hengtex.dialogOpen(n)
};
dialogContent = function(n) {
    hengtex.dialogContent(n)
};
...
newGuid = function() {
    return hengtex.newGuid()
};
formatDate = function(n, t) {
    return hengtex.formatDate(n, t)
};
toDecimal = function(n) {
    return hengtex.toDecimal(n)
};
request = function(n) {
    return hengtex.request(n)
};
changeUrlParam = function(n, t, i) {
    return hengtex.changeUrlParam(n, t, i)
};
$.currentIframe = function() {
    return hengtex.currentIframe()
};
$.isbrowsername = function() {
    return hengtex.isbrowsername()
};
...
$.standTabchange = function(n, t) {
    hengtex.changeStandTab({
        obj: n,
        id: t
    })
};
$.isNullOrEmpty = function(n) {
    return hengtex.isNullOrEmpty(n)
};
IsNumber = function(n) {
    return hengtex.isNumber(n)
};
IsMoney = function(n) {
    return hengtex.isMoney(n)
};
$.arrayClone = function(n) {
    return hengtex.arrayCopy(n)
};
$.windowWidth = function() {
    return $(window).width()
};
...
checkedArray = function(n) {
    return hengtex.checkedArray(n)
};
checkedRow = function(n) {
    return hengtex.checkedRow(n)
};
$(function() {
