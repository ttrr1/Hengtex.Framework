...
$.fn.frmDesign = function (options) {
   ...
   // divhtml += '<div class="item_row"><i id="dataitemlist" class="fa fa-book"></i>数据字典</div>';
    ...
    function textProperty(e_row) {
        ...
        _html += '<div class="field_title">占所在行分数</div>';
        _html += '<div class="field_control"><select id="control_percent" class="form-control"><option value="">==请选择==</option><option value="1">整行</option><option value="0.5">1/2行</option><option value="0.33">1/3行</option><option value="0.25">1/4行</option></select></div>';
        ...
        $html.find('#control_verify').change(function (e) {
            ...
            //e_row.width(item_field_value_width/4)
            //e_row.find('.item_field_value').width(item_field_value_width / 6);
