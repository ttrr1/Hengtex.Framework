    ...
    tablist = {
        newTab: function (item) {
            ...
            if (flag) {
                ...
                $.hengtextab.scrollToTab($('.menuTab.active'));
            }
        }
    }
    $.hengtextab = {
        ...
        scrollTabRight: function () {
            ...
            var tabOuterWidth = $.hengtextab.calSumWidth($(".content-tabs").children().not(".menuTabs"));
            ...
            if ($(".page-tabs-content").width() < visibleWidth) {
                ...
                scrollVal = $.hengtextab.calSumWidth($(tabElement).prevAll());
                if (scrollVal > 0) {
                    $('.page-tabs-content').animate({
        ...
        scrollTabLeft: function () {
            ...
            if ($(".page-tabs-content").width() < visibleWidth) {
                ...
                offsetVal = 0;
                if ($.hengtextab.calSumWidth($(tabElement).prevAll()) > visibleWidth) {
                    while ((offsetVal + $(tabElement).outerWidth(true)) < (visibleWidth) && tabElement.length > 0) {
                        offsetVal += $(tabElement).outerWidth(true);
        ...
        scrollToTab: function (element) {
            var marginLeftVal = $.hengtextab.calSumWidth($(element).prevAll()), marginRightVal = $.hengtextab.calSumWidth($(element).nextAll());
            var tabOuterWidth = $.hengtextab.calSumWidth($(".content-tabs").children().not(".menuTabs"));
            var visibleWidth = $(".content-tabs").outerWidth(true) - tabOuterWidth;
            var scrollVal = 0;
        ...
        init: function () {
            $('.menuItem').on('click', top.$.hengtextab.addTab);
            $('.menuTabs').on('click', '.menuTab i', top.$.hengtextab.closeTab);
            $('.menuTabs').on('click', '.menuTab', top.$.hengtextab.activeTab);
            $('.tabLeft').on('click', top.$.hengtextab.scrollTabLeft);
            $('.tabRight').on('click', top.$.hengtextab.scrollTabRight);
            $('.tabReload').on('click', top.$.hengtextab.refreshTab);
            ...
            $('.tabCloseOther').on('click', $.hengtextab.closeOtherTabs);
            $('.fullscreen').on('click', function () {
                if (!$(this).attr('fullscreen')) {
                    $(this).attr('fullscreen', 'true');
                    $.hengtextab.requestFullScreen();
                } else {
                    $(this).removeAttr('fullscreen')
                    $.hengtextab.exitFullscreen();
                }
            });
        }
    };
    $.hengtexindex = {
        ...
        loadMenu: function () {
            ...
            $ul.find("li").click(function () {
                ...
                var childNodes = $.hengtexindex.jsonWhere(data, function (v) { return v.ParentId == dataId });
                var _childNodeshtml = "";
                $.each(childNodes, function (i) {
                    var row = childNodes[i];
                    var subchildNodes = $.hengtexindex.jsonWhere(data, function (v) { return v.ParentId == row.ModuleId });
