...
var tablist = {
    newTab: function(n) {
        ...
        $(".menuTab").each(function() {
            if ($(this).data("id") == t) return $(this).hasClass("active") || ($(this).addClass("active").siblings(".menuTab").removeClass("active"), $.hengtextab.scrollToTab(this), $("#mainContent .LRADMS_iframe").each(function() {
    ...
    n.hengtextab = {
        ...
        activeTab: function() {
            ...
            n(this).hasClass("active") || (n("#mainContent .LRADMS_iframe").each(function() {
                ...
                !1
            }), n(this).addClass("active").siblings(".menuTab").removeClass("active"), n.hengtextab.scrollToTab(this));
        ...
        closeTab: function() {
            ...
            "fast"), n(this).parents(".menuTab").remove(), n("#mainContent .LRADMS_iframe").each(function() {
                ...
                if (n(this).data("id") == i) return n(this).remove(),
                !1
            }), n.hengtextab.scrollToTab(n(".menuTab.active"))),
        ...
        addTab: function() {
            ...
            return (i != "" && top.$.cookie("currentmoduleId", i, {
                ...
                if (n(this).data("id") == t) return n(this).hasClass("active") || (n(this).addClass("active").siblings(".menuTab").removeClass("active"), n.hengtextab.scrollToTab(this), n("#mainContent .LRADMS_iframe").each(function() {
                    if (n(this).data("id") == t) return n(this).show().siblings(".LRADMS_iframe").hide(),
                    !1
                })),
                r = !1,
                !1
            }), r && (f = '<a href="javascript:;" class="active menuTab" data-value=' + i + ' data-id="' + t + '">' + u + '<div class="tab_close "><\/div><\/a>', n(".menuTab").removeClass("active"), e = '<iframe class="LRADMS_iframe" id="iframe' + i + '" name="iframe' + i + '"  width="100%" height="100%" src="' + t + '" frameborder="0" data-id="' + t + '" seamless><\/iframe>', n("#mainContent").find("iframe.LRADMS_iframe").hide(), n("#mainContent").append(e), hengtex.loading({
                isShow: !0
            }), n("#mainContent iframe:visible").load(function() {
                hengtex.loading({
                    isShow: !1
                })
            }), n(".menuTabs .page-tabs-content").append(f), n.hengtextab.scrollToTab(n(".menuTab.active"))), n(this).parents(".popover-moreMenu").hide(), n(this).parents(".popover-menu").hide(), n(this).parents(".popover-menu-sub").hide(), !1)
        },
        scrollTabRight: function() {
            var f = Math.abs(parseInt(n(".page-tabs-content").css("margin-left"))),
            e = n.hengtextab.calSumWidth(n(".lea-tabs").children().not(".menuTabs")),
            ...
            t = n(t).next();
            r = n.hengtextab.calSumWidth(n(t).prevAll());
        ...
        scrollTabLeft: function() {
            ...
            for (t = n(".menuTab:first"), i = 0; i + n(t).outerWidth(!0) <= f;) i += n(t).outerWidth(!0),
            t = n(t).next();
            if (i = 0, n.hengtextab.calSumWidth(n(t).prevAll()) > r) {
                while (i + n(t).outerWidth(!0) < r && t.length > 0) i += n(t).outerWidth(!0),
                t = n(t).prev();
                u = n.hengtextab.calSumWidth(n(t).prevAll())
            }
        ...
        scrollToTab: function(t) {
            var f = n.hengtextab.calSumWidth(n(t).prevAll()),
            e = n.hengtextab.calSumWidth(n(t).nextAll()),
            o = n.hengtextab.calSumWidth(n(".lea-tabs").children().not(".menuTabs")),
        ...
        init: function() {
            n(".menuTabs").on("click", ".menuTab .tab_close", n.hengtextab.closeTab);
            n(".menuTabs").on("click", ".menuTab", n.hengtextab.activeTab);
            n(".tabLeft").on("click", n.hengtextab.scrollTabLeft);
            n(".tabRight").on("click", n.hengtextab.scrollTabRight);
            n(".tabReload").on("click", n.hengtextab.refreshTab);
            ...
            n(".tabCloseOther").on("click", n.hengtextab.closeOtherTabs);
            n(".fullscreen").on("click",
            function() {
                n(this).attr("fullscreen") ? (n(this).removeAttr("fullscreen"), n.hengtextab.exitFullscreen()) : (n(this).attr("fullscreen", "true"), n.hengtextab.requestFullScreen())
            })
        }
    };
    n.hengtexindex = {
        ...
        loadMenu: function(t) {
            var e = !1,
            o = n(".lea-Head").width() - n.hengtextab.calSumWidth(n(".lea-Head").children().not(".left-bar")),
            i = top.hengtex.data.get(["authorizeMenu"]),
            r = "",
            u = 0,
            s = "",
            f = "";
            ...
            function(t) {
                ...
                e,
                c;
                h.F_ParentId == "0" && (e = "", e += '<li class="treeview">', e += "<a>", e += '<i class="' + h.F_Icon + '"><\/i><span>' + h.F_FullName + "<\/span>", e += "<\/a>", c = n.hengtexindex.jsonWhere(i,
                function(n) {
                ...
                n(".menuiframe").unbind();
                n(".menuiframe").on("click", n.hengtextab.addTab);
