...
namespace Hengtex.Application.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //hengtex
            bundles.Add(new StyleBundle("~/Content/styles/hengtex-ui.css").Include(
                        "~/Content/styles/hengtex-ui.css"));
            bundles.Add(new ScriptBundle("~/Content/scripts/utils/js").Include(
                       "~/Content/scripts/utils/hengtex-ui.js",
                       "~/Content/scripts/utils/hengtex-form.js"));
            //hengtex Order
            ...
            //工作流
            bundles.Add(new StyleBundle("~/Content/styles/hengtex-flowall.css").Include(
            "~/Content/styles/hengtex-ckbox-radio.css",
            "~/Content/styles/hengtex-applayout.css",
            "~/Content/styles/hengtex-flow.css"));
            bundles.Add(new ScriptBundle("~/Content/scripts/flow/js").Include(
              "~/Content/scripts/utils/hengtex-applayout.js",
              "~/Content/scripts/plugins/flow-ui/flow.js",
              "~/Content/scripts/utils/hengtex-flowlayout.js"));
