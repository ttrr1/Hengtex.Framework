...
namespace Hengtex.Application.Service.ErpManage
{
    ...
    /// </summary>
    public class con_pan_head_downService : RepositoryFactory, con_pan_head_downIService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        {
            return this.ERPRepository().FindList<con_pan_head_downEntity>(pagination);
        }
        /// <summary>
        /// 获取实体
        /// </summary>
        ...
        {
            return this.ERPRepository().FindEntity<con_pan_head_downEntity>(keyValue);
        }
        /// <summary>
        /// 获取子表详细信息
        /// </summary>
        ...
        public void RemoveForm(string keyValue)
        {
            ...
            try
            {
                db.Delete<con_pan_head_downEntity>(keyValue);
