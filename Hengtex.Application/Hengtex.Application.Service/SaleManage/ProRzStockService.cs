...
namespace Hengtex.Application.Service.SaleManage
{
    ...
    /// 描 述：染整档案管理
    /// </summary>
    public class ProRzStockService : RepositoryFactory<ProRzStockEntity>, IProRzStockService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<ProRzStockEntity> GetList()
        {
            var expression = LinqExtensions.True<ProRzStockEntity>();
        ...
        /// <returns></returns>
        public IEnumerable<ProRzStockEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<ProRzStockEntity>();
        ...
        /// <returns></returns>
        public ProRzStockEntity GetEntity(string keyValue)
        {
          ...
          return  this.ERPRepository().FindList(strSql.ToString(), parameter).FirstOrDefault<ProRzStockEntity>();
