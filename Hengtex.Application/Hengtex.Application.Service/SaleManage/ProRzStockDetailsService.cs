...
namespace Hengtex.Application.Service.SaleManage
{
    ...
    /// 描 述：染整详情档案管理
    /// </summary>
    public class ProRzStockDetailsService : RepositoryFactory<ProRzStockDetailsEntity>, IProRzStockDetailsService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<ProRzStockDetailsEntity> GetList()
        {
            var expression = LinqExtensions.True<ProRzStockDetailsEntity>();
        ...
        /// <returns></returns>
        public IEnumerable<ProRzStockDetailsEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<ProRzStockDetailsEntity>();
        ...
        /// <returns></returns>
        public ProRzStockDetailsEntity GetEntity(string keyValue)
        {
