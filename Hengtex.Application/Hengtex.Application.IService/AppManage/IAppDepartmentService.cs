...
namespace Hengtex.Application.IService.AppManage
{
    ...
    public interface IAppDepartmentService
    {
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<AppDepartmentEntity> GetList();
        /// <summary>
        /// 部门实体
        /// </summary>
        /// <param name="keyValue">主键值</param>
        /// <returns></returns>
        AppDepartmentEntity GetEntity(string keyValue);
        #endregion
        ...
        /// <returns></returns>
        void SaveForm(string keyValue, AppDepartmentEntity departmentEntity);
        #endregion
    }
}
