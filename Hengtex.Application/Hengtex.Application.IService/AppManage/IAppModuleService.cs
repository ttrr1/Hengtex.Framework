...
namespace Hengtex.Application.IService.AppManage
{
    ...
    public interface IAppModuleService
    {
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<AppModuleEntity> GetList();
        /// <summary>
        /// 功能实体
        /// </summary>
        /// <param name="keyValue">主键值</param>
        /// <returns></returns>
        AppModuleEntity GetEntity(string keyValue);
        #endregion
        ...
        /// <returns></returns>
        void SaveForm(string keyValue, AppModuleEntity moduleEntity, List<AppModuleButtonEntity> moduleButtonList, List<AppModuleColumnEntity> moduleColumnList);
        #endregion
    }
}
