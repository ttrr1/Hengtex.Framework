...
namespace Hengtex.Application.IService.ErpManage
{
    ...
    /// 描 述：染整档案管理
    /// </summary>
    public interface IProRbStockService
    {
        #region 获取数据
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<ProRbStockEntity> GetList();
        ...
        /// <returns></returns>
        IEnumerable<ProRbStockEntity> GetPageList(Pagination pagination, string queryJson);
        ...
        /// <returns></returns>
        ProRbStockEntity GetEntity(string keyValue);
