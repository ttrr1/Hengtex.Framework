app.config(function ($stateProvider, $urlRouterProvider) {
    ...
    .state('tab.cases', {
        ...
        views: {
         ...
         // 实例首页
    .state('tab.caseshome', {
        url: '/caseshome/:domainName',
        views: {
            'tab-cases': {
                templateUrl: 'templates/tab-casesHome.html',
                controller: 'CasesHomeCtrl'
            }
        }
    })
    //// 盘头信息查询
    //.state('tab.cases.panlist', {
    //    url: '/cases',
    //    views: {
    //        'tab-cases.panlist': {
    //            templateUrl: 'templates/cases/cases-panlist.html',
