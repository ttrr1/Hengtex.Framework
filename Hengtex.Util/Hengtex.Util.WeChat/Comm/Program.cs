...
using Hengtex.Util.WeChat.Model;
using Hengtex.Util.WeChat.Model.Request;
using Hengtex.Util.WeChat.Model.Request.SendMessage;
using Hengtex.Util;
using Hengtex.Util.WeChat.Helper;

namespace Hengtex.Util.WeChat
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //        {
            //        description="测试新闻",
            //        picurl="http://www.hengtex.cn/images/banner3.jpg",
            //        url="http://www.hengtex.cn/fdms/index.html",
            //        title="恒泰在线"
            //        },
            //                            new SendNews.SendItem
            //        {
